...
<div class="main-body">
  ...
  <div class="main-content">
    <div class="main-content-div">
      <p class="main-content-div-index">查看车辆商品库<span class="page-error">${errorMsg}</span></p>
        ...
        <div class="form-group">
          <div class="col-md-8">
            ...
            <div class="input-group">
              ...
              <input type="text" name="cheXing" id="cheXing" class="form-control"  value="${productInfo.info.cheXing}"  readonly="readonly"/>
        ...
        <div class="form-group">
          <div class="col-md-8">
            ...
            <div class="input-group">
              ...
              <input type="number" name="sellPrice" id="sellPrice" class="form-control"  value="${productInfo.sellPrice}" readonly="readonly"/>
            </div>
          </div>
        </div>
        <div class="form-group">
          <div class="col-md-8">
            ...
            <div class="input-group">
              <input type="number" name="pCount" id="pCount" class="form-control"  value="${productInfo.pCount}" readonly="readonly" />
              <input type="number" name="advancePrice" id="advancePrice" class="form-control"  value="${productInfo.advancePrice}" readonly="readonly"/>
              <input type="date" name="yxq" id="yxq" class="form-control" value="<fmt:formatDate value='${productInfo.yxq}' pattern='yyyy-MM-dd'/>"  readonly="readonly">
            </div>
        </div>
        </div>
        <div class="form-group">
          <div class="col-md-8">
            ...
            <div class="input-group">
              <input name="allowArea" id="allowArea" type="hidden"  value="${productInfo.allowArea}" readonly="readonly"/>
              <ul class="ztree" id="allowAreaList" readonly="readonly" disabled="disable"></ul>
            </div>
          </div>
        </div>
        <div class="form-group">
    ...
    function initMenu()
    {
      ...
      var setting = {
        async : {
          ...
          url:'${ctx}/getViewCity?city='+cityCode,
        },
        data:{
          simpleData:{
            enable:true,
